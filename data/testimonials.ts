...
export const testimonials = [
  {
    quote:
      "We rolled out 400 branch displays across North India in six weeks. Every unit arrived identical, on spec, on time. That kind of consistency is rare.",
  ...
  {
    quote:
      "They took a rough sketch of a counter unit and returned a working prototype in ten days. The final production run was better than the drawing.",
    name: "Retail Marketing Lead",
    company: "FMCG Brand",
    location: "Gurugram",
  },
  {
