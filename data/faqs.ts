export const faqs = [
  ...
  },
  {
    ...
    a: "Within 24 hours, directly from our production team. If your requirement needs engineering input, we'll call to clarify before quoting so the price doesn't change later.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Screen printing, UV printing, vinyl graphics and colour-matched acrylic are all done in-house to your brand guidelines.",
  },
  {
    q: "What are the typical lead times?",
    a: "Standard catalogue items ship in 7–10 days. Custom fabrication typically runs 2–3 weeks including a prototype approval round, depending on quantity.",
  },
];
