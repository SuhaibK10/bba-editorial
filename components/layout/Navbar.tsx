...
export default function Navbar() {
  ...
  // GSAP hamburger animation — create once, play/reverse on toggle
  useEffect(() => {
    tlRef.current = gsap.timeline({ paused: true })
      .to(topBarRef.current, { rotate: 45, y: 7, duration: 0.3, ease: "power2.inOut" }, 0)
            ...
            <div className="flex items-center gap-4">
              <Link
                ...
                className="
                  ...
                  h-9 px-[1.125rem] rounded-full
                  bg-accent text-white font-body font-semibold text-sm tracking-[-0.01em]
                  shadow-[0_1px_2px_rgba(0,0,0,0.05),0_2px_8px_rgba(0,87,255,0.18)]
                  hover:bg-accent-hover hover:-translate-y-px
                  hover:shadow-[0_2px_4px_rgba(0,0,0,0.07),0_4px_14px_rgba(0,87,255,0.24)]
            ...
            >
              <Link
                ...
                className="flex items-center justify-center gap-2
                           h-14 px-6 rounded-full w-full
                           bg-accent text-white font-body font-semibold text-base tracking-[-0.01em]
              ...
              <a
                ...
                className="flex items-center justify-center gap-2.5
                           h-14 px-6 rounded-full w-full
                           bg-[#F5F5F7] text-[#1A1A1A] font-body font-medium text-base
                           border border-[#E8E8ED] hover:border-[#C7C7CC] hover:bg-[#EFEFF4]
                           active:scale-[0.98]
                           transition-all duration-200"
              >
