  ...
  return (
    <section className="section-pad">
      <div className="container-wide">
        <div
          className="border border-[#E0E0E0] rounded-3xl p-12 md:p-20
                     flex flex-col md:flex-row items-start md:items-center
                     justify-between gap-10 bg-surface"
        >
          {/* Text */}
          <div>
            <motion.h2
              ...
              className="section-heading-md mb-4"
            >
              Ready to build something<br />
              <span className="text-[#0057FF]">remarkable?</span>
            </motion.h2>
            <motion.p
            ...
            >
              ...
              No minimum order for first-time clients.
            </motion.p>
          </div>
